...
import 'package:quenero_coin/src/exceptions/wallet_creation_exception.dart';
import 'package:quenero_coin/src/exceptions/wallet_restore_from_keys_exception.dart';
import 'package:quenero_coin/src/exceptions/wallet_restore_from_seed_exception.dart';

final createWalletNative = queneroApi
    .lookup<NativeFunction<create_wallet>>('create_wallet')
    .asFunction<CreateWallet>();

final restoreWalletFromSeedNative = queneroApi
    .lookup<NativeFunction<restore_wallet_from_seed>>(
        'restore_wallet_from_seed')
    .asFunction<RestoreWalletFromSeed>();

final restoreWalletFromKeysNative = queneroApi
    .lookup<NativeFunction<restore_wallet_from_keys>>(
        'restore_wallet_from_keys')
    .asFunction<RestoreWalletFromKeys>();

final isWalletExistNative = queneroApi
    .lookup<NativeFunction<is_wallet_exist>>('is_wallet_exist')
    .asFunction<IsWalletExist>();

final loadWalletNative = queneroApi
