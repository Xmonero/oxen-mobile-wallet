...
import 'package:quenero_coin/src/native/stake.dart' as stake_native;
...
PendingTransactionDescription _createStakeSync(Map args) {
  final serviceNodeKey = args['masternode_key'] as String;
...
Future<PendingTransactionDescription> createStake(
    ...
    compute(_createStakeSync,
        {'masternode_key': serviceNodeKey, 'amount': amount});
...
Future<PendingTransactionDescription> submitStakeUnlock(String serviceNodeKey) =>
    compute(_submitStakeUnlockSync, {'masternode_key': serviceNodeKey});
