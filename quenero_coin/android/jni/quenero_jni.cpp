#include <string.h>
#include <jni.h>
#include "../../ios/Classes/quenero_api.cpp"
#include <stdbool.h>
...
struct QueneroWalletListenerWrapper: Quenero::WalletListener {
    jobject listener;

    QueneroWalletListenerWrapper(JNIEnv *env, jobject aListener) {
...
static QueneroWalletListenerWrapper *listenerWrapper = NULL;
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *_jvm, void *reserved) {
    ...
    listener_class = static_cast<jclass>(jenv->NewGlobalRef(jenv->FindClass("io/quenero/coin/QueneroWalletSyncStatusListener")));

    return JNI_VERSION_1_6;
}

JNIEXPORT void JNICALL
Java_io_quenero_coin_QueneroApi_setupListenerJNI(JNIEnv *env, jobject inst, jobject listener) {
    listenerWrapper = new QueneroWalletListenerWrapper(env, listener);
