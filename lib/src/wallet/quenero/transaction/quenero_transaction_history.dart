...
import 'package:quenero_coin/transaction_history.dart' as quenero_transaction_history;
...
List<TransactionInfo> _getAllTransactions(dynamic _) => quenero_transaction_history
    .getAllTransactions()
    .map((row) => TransactionInfo.fromRow(row))
    .toList();

class QueneroTransactionHistory extends TransactionHistory {
  QueneroTransactionHistory()
  ...
  @override
  Future<int> count() async => quenero_transaction_history.countOfTransactions();
  ...
  Future refresh() async {
    ...
    try {
      _isRefreshing = true;
      quenero_transaction_history.refreshTransactions();
      _isRefreshing = false;
